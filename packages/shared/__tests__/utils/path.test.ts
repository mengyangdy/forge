...
import { deepGet } from "../../src/utils/get.js";
import { keyOfName, toSegments } from "../../src/utils/path-utils.js";
import { deepSet, deepUnset } from "../../src/utils/set.js";
...
describe("path utilities", () => {
  ...
  it("unsets object keys and array items immutably", () => {
    ...
    expect(deepUnset(source, ["items", 0])).toEqual({
      items: ["b"],
      user: { age: 18, name: "Alex" },
    });
