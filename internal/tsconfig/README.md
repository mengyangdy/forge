...
```json
{
  "extends": "@forge/tsconfig/library.json"
}
```
...
用于 Web 专用的包（如 `@forge/web-*`）：

```json
{
  "extends": "@forge/tsconfig/web.json"
}
```
...
```json
{
  "extends": "@forge/tsconfig/web-app.json",
  "compilerOptions": {
    "paths": {
      "@/*": ["./src/*"]
    }
...
```json
{
  "extends": "@forge/tsconfig/react-native.json"
}
```
...
```bash
# 库包
echo '{"extends": "@forge/tsconfig/library.json", "include": ["src/**/*"]}' > packages/core-auth/tsconfig.json

# Web 应用
echo '{"extends": "@forge/tsconfig/web-app.json", "include": ["src/**/*"]}' > apps/admin/tsconfig.json
```
...
```json
{
  ...
  "compilerOptions": {
    "paths": {
      "@/*": ["./src/*"],
      "@forge/core-*": ["../../packages/core-*/src"],
      "@forge/web-*": ["../../packages/web-*/src"]
    }
  }
}
```
