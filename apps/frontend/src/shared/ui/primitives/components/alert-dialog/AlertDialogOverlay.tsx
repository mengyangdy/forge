...
const AlertDialogOverlay = forwardRef<ComponentRef<typeof Overlay>, AlertDialogOverlayProps>(
  (props, ref) => {
    ...
    return <Overlay className={mergedClass} data-slot="alert-dialog-overlay" {...rest} ref={ref} />;
  },
);
