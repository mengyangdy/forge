    ...
    <AlertDialogRoot {...props}>
      ...
      <Portal forceMount={forceMountPortal}>
        ...
        <AlertDialogContent
          ...
          {...contentProps}
        >
          <AlertDialogHeader className={classNames?.header} size={size} {...headerProps}>
            <AlertDialogTitle className={classNames?.title} size={size} {...titleProps}>
          ...
          {footer !== null && footer !== false && (
            <AlertDialogFooter className={classNames?.footer} size={size} {...footerProps}>
              {footer || (
                <>
                  {showCancel ? (
                  ...
                  <AlertDialogAction onClick={onOk} {...okButtonProps}>
                    {okText}
                  </AlertDialogAction>
                </>
              )}
