...
const AlertDialogTitle = forwardRef<ComponentRef<typeof Title>, AlertDialogTitleProps>(
  (props, ref) => {
    ...
    return <Title className={mergedClass} data-slot="alert-dialog-title" {...rest} ref={ref} />;
  },
);
