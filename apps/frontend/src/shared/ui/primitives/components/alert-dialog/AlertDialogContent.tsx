...
const AlertDialogContent = forwardRef<ComponentRef<typeof Content>, AlertDialogContentProps>(
  (props, ref) => {
    ...
    return <Content className={mergedClass} data-slot="alert-dialog-content" {...rest} ref={ref} />;
  },
);
