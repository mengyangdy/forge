...
const CheckboxControl = React.forwardRef<ComponentRef<typeof Root>, CheckboxControlProps>(
  (props, ref) => {
    ...
    return <Root className={mergedCls} data-slot="checkbox-control" {...rest} ref={ref} />;
  },
);
