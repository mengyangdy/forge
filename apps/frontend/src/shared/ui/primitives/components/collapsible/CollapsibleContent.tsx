...
const CollapsibleContent = forwardRef<ComponentRef<typeof Content>, CollapsibleContentProps>(
  (props, ref) => {
    ...
    return <Content className={mergedCls} data-slot="collapsible-content" ref={ref} {...rest} />;
  },
);
