...
export interface TabsListProps
  extends StyledComponentProps<_TabsListProps>, Pick<_TabsRootProps, "value"> {
  /**
 ...
 */
export interface TabsTriggerProps extends StyledComponentProps<
  Omit<_TabsTriggerProps, "className" | "type">
> {
  /**
 ...
 * ```
 */
export interface TabsContentProps extends StyledComponentProps<
  Omit<_TabsContentProps, "className">
> {
  /**
...
export interface TabsProps<T extends TabsOptionData = TabsOptionData>
  extends
    TabsRootProps,
    Pick<TabsListProps, "enableIndicator" | "loop" | "orientation" | "shape" | "type"> {
  /**
