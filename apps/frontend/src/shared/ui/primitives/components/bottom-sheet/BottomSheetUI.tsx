...
const BottomSheetUI = forwardRef<ComponentRef<typeof Content>, BottomSheetProps>((props, ref) => {
  ...
  return (
    <_Root shouldScaleBackground={shouldScaleBackground} {...props}>
      <DialogTrigger asChild>{trigger}</DialogTrigger>

      <BottomSheetContent classNames={classNames} ref={ref} size={size} {...contentProps}>
        <DialogHeader className={classNames?.header} size={size} {...headerProps}>
          <BottomSheetTitle className={classNames?.title} size={size} {...titleProps}>
            {title}
          </BottomSheetTitle>
        ...
        {showClose ? (
          <BottomSheetClose className={classNames?.close} size={size} {...closeProps} />
        ) : null}
