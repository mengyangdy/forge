...
const BottomSheetContent = forwardRef<ComponentRef<typeof Content>, BottomSheetContentProps>(
  (props, ref) => {
    ...
    return (
      <Portal>
        ...
        <Content className={mergedCls} data-slot="bottom-sheet-content" ref={ref} {...rest}>
