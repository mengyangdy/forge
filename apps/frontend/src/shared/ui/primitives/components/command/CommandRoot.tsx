...
const CommandRoot = forwardRef<ComponentRef<typeof _CommandRoot>, CommandRootProps>(
  (props, ref) => {
    ...
    return <_CommandRoot className={mergedClass} data-slot="command-root" ref={ref} {...rest} />;
  },
);
