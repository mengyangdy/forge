 ...
 */
export type CommandGroupProps = StyledComponentProps<
 ...
 */
export type CommandInputProps = StyledComponentProps<
  Omit<ComponentPropsWithoutRef<typeof CommandInput>, "size">
> & {
  /**
 ...
 */
export type CommandItemProps = StyledComponentProps<
 ...
 */
export type CommandSeparatorProps = StyledComponentProps<
...
export interface CommandDialogProps extends Omit<DialogProps, "classNames" | "footer" | "trigger"> {
  ...
  classNames?: Pick<
    DialogClassNames,
    "close" | "content" | "description" | "header" | "overlay" | "title"
  >;
}
