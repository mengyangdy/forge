...
const DialogDescription = forwardRef<ComponentRef<typeof _Description>, DialogDescriptionProps>(
  (props, ref) => {
    ...
    return (
      <Description {...rest} className={mergedClass} data-slot="dialog-description" ref={ref} />
    );
  },
);
