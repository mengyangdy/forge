...
const DialogOverlay = forwardRef<ComponentRef<typeof _Overlay>, DialogOverlayProps>(
  (props, ref) => {
    ...
    return <Overlay {...rest} className={mergedClass} data-slot="dialog-overlay" ref={ref} />;
  },
);
