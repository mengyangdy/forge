 ...
 */
export interface PaginationRootProps extends StyledComponentProps<
 ...
 */
export interface PaginationContentProps extends StyledComponentProps<
 ...
 */
export interface PaginationItemProps extends StyledComponentProps<
 ...
 */
export interface PaginationNavigationButtonProps extends StyledComponentProps<
  React.ComponentPropsWithRef<"button">
> {
  /**
 ...
 */
export interface PaginationEllipsisProps extends StyledComponentProps<
  React.ComponentPropsWithRef<"div">
> {
  /**
   * Custom icon to display
 ...
 * ```
 */
export interface PaginationProps extends StyledComponentProps<
  Omit<React.ComponentPropsWithRef<"nav">, "onChange">
> {
  /**
