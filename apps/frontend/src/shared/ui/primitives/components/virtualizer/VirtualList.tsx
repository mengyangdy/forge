...
>(
  ...
  useImperativeHandle(ref, () => {
    ...
    Object.assign(result, elementVirtualizer);
    return result as unknown as VirtualizerList<TScrollElement, TItemElement>;
  ...
  const content = () => {
    ...
    return items.map((virtualItem) => {
      ...
      return (
        <Slot key={String(key)} style={itemStyle}>
          {renderItem({
            item,
            index: virtualItem.index,
            virtualItem,
  ...
  return (
    <div {...containerProps} className={mergedCls} ref={rootRef} style={containerStyle}>
