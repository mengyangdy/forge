...
const NavigationMenuRoot = forwardRef<ComponentRef<typeof Root>, NavigationMenuRootProps>(
  (props, ref) => {
    ...
    return <Root className={mergedCls} data-slot="navigation-menu-root" ref={ref} {...rest} />;
  },
);
