...
function getItem(
  itemOption: NavigationMenuItemOption,
): [NavigationMenuItemOption, NavigationMenuItemChildOption[]] {
...
const NavigationMenuUI = (props: NavigationMenuProps) => {
  ...
  return (
    <NavigationMenuRoot {...rest}>
      <NavigationMenuList className={classNames?.list} size={size} {...listProps}>
        {items.map((itemOption, index) => {
          ...
          return (
            <NavigationMenuItem className={classNames?.item} key={itemKey} {...itemProps}>
              {isLink(itemOption) ? (
                <NavigationMenuLink
                ...
                <>
                  ...
                  <NavigationMenuContent className={classNames?.content} {...contentProps}>
      ...
      <NavigationMenuIndicator classNames={classNames} size={size} />

      <NavigationMenuViewport classNames={classNames} size={size} />
    </NavigationMenuRoot>
  );
};
