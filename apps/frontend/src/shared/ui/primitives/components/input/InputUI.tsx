...
const InputUI = forwardRef<HTMLInputElement, InputProps>((props, ref) => {
  const { className, classNames, clearable, disabled, leading, readOnly, size, trailing, ...rest } =
    props;
  ...
  return (
    ...
    >
      ...
      {clearable ? (
        <X className={mergedClearableCls} data-slot="input-clearable" onClick={handleClear} />
      ) : null}
