...
import type { AllPathsKeys, ArrayElementValue, ArrayKeys } from "@/shared/type-utils";
...
export type ListProps<
  Values = any,
  K extends ArrayKeys<Values> & string = ArrayKeys<Values> & string,
> = {
...
function List<Values = any>(props: ListProps<Values>) {
  ...
  const { arrayOp, getInternalHooks, isDisabled, isHidden } =
