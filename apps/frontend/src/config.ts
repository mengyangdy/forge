import type { AdminDevtoolsConfig } from "@/shared/admin-devtools";
import { defaultThemeSettings } from "@/shared/admin-theme";
...
// ============================================================================
// Re-export Semi UI helpers from admin-theme（auto-import 兼容别名）
// ============================================================================
export {
  destroyMessage,
  destroyNotification,
