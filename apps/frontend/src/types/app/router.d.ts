...
declare global {
  namespace Router {
    ...
    type RouteId = keyof RouteIdRegistry extends never
      ? string
      : Extract<keyof RouteIdRegistry, string>;
    ...
    type Extra = keyof MenuExtraRegistry extends never
      ? string
      : Extract<keyof MenuExtraRegistry, string>;
